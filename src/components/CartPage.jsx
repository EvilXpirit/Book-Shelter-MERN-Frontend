...
const CartPage = () => {
  ...
  return (
    <div className="w-full h-full bg-black/50 flex justify-center items-center overflow-y-auto">
      <div className="bg-white/90 p-6 mt-32 mb-10 rounded-lg shadow-lg w-5/6 max-h-screen">
