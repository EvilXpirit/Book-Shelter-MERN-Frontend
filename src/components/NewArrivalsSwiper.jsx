      ...
      >
        {books.map((book) => (
          <SwiperSlide key={book._id}>
            ...
            <div className=''>
              <img src={book.imageUrl} alt={book.bookName} className=" w-full h-48 object-cover object-top transition-all duration-200 ease-in-out transform hover:h-full hover:scale-105" />
              ...
              <button onClick={() => openModal(book)} className="mx-2 px-2 py-2 bg-yellow-500 text-white rounded hover:shadow-lg"><FontAwesomeIcon icon={faEye} size="lg" /></button>
            </div>
          </SwiperSlide>
        ))}
      </Swiper>
